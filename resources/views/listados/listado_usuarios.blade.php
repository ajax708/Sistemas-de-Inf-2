...
<div class="box-body box-white">
    ...
    <div class="table-responsive" >
		...
		<tr role="row" class="odd">
			...
			<button type="button" class="btn btn-sm btn-warning" title="Editar" onclick="verinfo_usuario({{  $usuario->id }})" >
				<i class="fas fa-edit"></i>
			</button>
			<button type="button"  class="btn btn-sm btn-danger" title="Borrar"  onclick="borrado_usuario({{  $usuario->id }});"  >
